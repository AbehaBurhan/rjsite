                ...
                <div class="col-xl-6 col-lg-7 col-sm-8 position-relative text-center page-title-extra-small"
                    ...
                    <div>
                        <h1 class="text-uppercase mb-15px alt-font text-white opacity-6 fw-500 ls-2px"
                            data-fancy-text='{ "opacity": [0, 1], "translateY": [50, 0], "filter": ["blur(20px)", "blur(0px)"], "string": ["Data & Integrations"], "duration": 400, "delay": 0, "speed": 50, "easing": "easeOutQuad" }'>
                        </h1>
                    </div>
                    <h2 class="m-auto text-white alt-font text-shadow-double-large fw-700 w-90 xl-w-100"
                        data-fancy-text='{ "opacity": [0, 1], "translateY": [50, 0], "filter": ["blur(20px)", "blur(0px)"], "string": ["Leveraging Technology for Customer Insights"], "duration": 400, "delay": 0, "speed": 50, "easing": "easeOutQuad" }'>
                    </h2>
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-1">
                <div class="col-lg-7 text-center appear anime-child anime-complete"
                    ...
                    <h3 class="alt-font text-dark-gray fw-600 ls-minus-1px shadow-none shadow-in"
                        data-shadow-animation="true" data-animation-delay="1000" style="">Understanding Customers for
                        <span class="text-highlight fw-800">Business Success<span
                                class="bg-gradient-emerald-blue-emerald-green h-8px bottom-10px opacity-6 separator-animation"></span></span>
                    </h3>
                    <span class="alt-font text-uppercase fw-600 d-inline-block ls-1px mb-5" style="">Utilize data
                        aggregation and integration across your technology infrastructure to gain deeper insights into
                        customer behaviors and preferences, driving business growth and development.
            ...
            <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 justify-content-center appear anime-child anime-complete"
                ...
                <div class="col icon-with-text-style-03 mb-10px" style="">
                    <div class="feature-box p-6 overflow-hidden">
                        <div class="feature-box-icon">
                            <a href="https://www.shopify.com/plus" target="_blank">

                                <img src="shopify-plus-logo--black.jpg" class="img-fluid mb-4" alt="">
                            </a>
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                            <a href="https://www.shopify.com/plus" target="_blank"
                                class="d-inline-block alt-font fw-700 text-dark-gray mb-5px fs-18">Shopify Plus
                            </a>
                            <p class="w-80 md-w-100 m-auto">Shopify Plus gives you a multi-channel platform with unmatched
                                scalability so you can grow your business, instead of worrying about your website.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="feature-box p-6 overflow-hidden">
                        <div class="feature-box-icon">
                            <a href="https://www.klaviyo.com/" target="_blank">
                                ...
                                <img src="klaviyo-logo.jpg" class="img-fluid mb-4" alt="">

                            </a>
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                            <a href="https://www.klaviyo.com/" target="_blank"
                                class="d-inline-block alt-font fw-700 text-dark-gray mb-5px fs-18">klaviyo</a>
                            <p class="w-80 md-w-100 m-auto">Klaviyo, Inc. is a global technology company that provides a
                                marketing automation platform, used primarily for email marketing and SMS marketing. The
                                company is headquartered in Boston, Massachusetts, United States.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03 mb-10px" style="">
                    <div class="feature-box p-6 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <a href="https://mailchimp.com/" target="_blank"
                                class="d-inline-block alt-font fw-700 text-dark-gray mb-5px fs-18">Mailchimp</a>
                            <p class="w-80 md-w-100 m-auto">Mailchimp is a marketing automation and email marketing
                                platform. "Mailchimp" is the trade name of its operator, Rocket Science Group, an American
                                company founded in 2001 by Ben Chestnut and Mark Armstrong, with Dan Kurzius joining at a
                                later date.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03 sm-mb-10px" style="">
                    <div class="feature-box p-6 overflow-hidden">
                        <div class="feature-box-icon">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <a href="https://sendgrid.com/" target="_blank"
                                class="d-inline-block alt-font fw-700 text-dark-gray mb-5px fs-18">Sendgrid</a>
                            <p class="w-80 md-w-100 m-auto">SendGrid is a Denver, Colorado-based customer communication
                                platform for transactional and marketing email. The company was founded by Isaac Saldana,
                                Jose Lopez, and Tim Jenkins in 2009, and incubated through the Techstars accelerator
                                program.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03 xs-mb-10px" style="">
                    <div class="feature-box p-6 overflow-hidden">
                        <div class="feature-box-icon">
                            <a href="https://www.bazaarvoice.com/" target="_blank">

                                <img src="bazaarvoice-logo.png" class="w-50 mb-4" alt="">

                            </a>
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                            <a hhref="https://www.bazaarvoice.com/" target="_blank"
                                class="d-inline-block alt-font fw-700 text-dark-gray mb-5px fs-18">Bazaarvoice
                            </a>
                            <p class="w-80 md-w-100 m-auto">Bazaarvoice is a technology company based in Austin, Texas,
                                that provides software that allows brands and retailers to collect and display several types
                                of user-generated content on their e-commerce websites.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-6 overflow-hidden">
                        <div class="feature-box-icon" style="background: rgba(128, 128, 128, 0.547)">
                            <a href="https://moose.com.pk/" target="_blank">
                                <img src="moosecommerce.png" class="w-75 mb-4" alt="">
                            </a>
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                            <a href="https://moose.com.pk/" target="_blank"
                                class="d-inline-block alt-font fw-700 text-dark-gray mb-5px fs-18">Moose Commerce
                            </a>
                            <p class="w-80 md-w-100 m-auto">Moose Commerce follows all legal requirements to protect your
                                privacy. Our Privacy Policy is a legal statement that explains how we may collect
                                information from ...</p>
                        </div>
                    </div>
                </div>
    ...
    <section>
        <div class="container">
            <div class="row mb-8 align-items-center">
                <div class="col-lg-6 md-mb-50px sm-mb-30px">
                    <figure class="position-relative mb-0 overflow-hidden">
                        <img src="integrations/1.png" class="w-100"
                            alt="" data-no-retina="">
                        <figcaption
                            class="position-absolute text-center left-0px bottom-0px pt-35px pb-35px ps-15px pe-15px bg-white">
                            <span
                                class="fs-90 lh-85 text-dark-gray ls-minus-2px position-relative fw-700 mb-5px d-block alt-font">20<sub
                                    class="fs-40 lh-40 text-dark-gray position-relative top-minus-40px">+</sub></span>
                            <span
                                class="d-block mx-auto fs-14 fw-600 lh-20 w-200px text-center text-dark-gray text-uppercase">Years
                                working experience</span>
                        </figcaption>
                    </figure>
                </div>
                <div class="col-xl-5 col-lg-6 offset-xl-1 text-center text-md-start appear anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    <h2 class="text-dark-gray fw-600 ls-minus-3px alt-font highlight-separator-small" style="">Know
                        your customers.</h2>
                    <p class="w-85 sm-w-100" style="">When navigating retail and marketplace avenues, customer
                        engagement can be restricted. Our Data & Integrations solution offers a remedy for this.</p>

                </div>
            </div>
            <div class="row mb-8 align-items-center">

                <div class="col-xl-5 col-lg-6 text-center text-md-start appear anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    <h2 class="text-dark-gray fw-600 ls-minus-3px alt-font highlight-separator-small" style="">Data first.</h2>
                    <p class="w-85 sm-w-100" style="">Identify the ultimate consumers purchasing your products to gain insights into your audience and reveal avenues for growth.</p>

                </div>
                <div class="col-lg-6 offset-xl-1 md-mb-50px sm-mb-30px">
                    <figure class="position-relative mb-0 overflow-hidden">
                        <img src="integrations/3.png" class="w-100"
                            alt="" data-no-retina="">
                        <figcaption
                            class="position-absolute text-center left-0px bottom-0px pt-35px pb-35px ps-15px pe-15px bg-white">
                            <span
            ...
            <div class="row mb-8 align-items-center">
                <div class="col-lg-6 md-mb-50px sm-mb-30px">
                    <figure class="position-relative mb-0 overflow-hidden">
                        <img src="integrations/4.png" class="w-100"
                            alt="" data-no-retina="">
                        <figcaption
                            class="position-absolute text-center left-0px bottom-0px pt-35px pb-35px ps-15px pe-15px bg-white">
                            <span
                ...
                <div class="col-xl-5 col-lg-6 offset-xl-1 text-center text-md-start appear anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    <h2 class="text-dark-gray fw-600 ls-minus-3px alt-font highlight-separator-small" style="">Integrate and elevate.</h2>
                    <p class="w-85 sm-w-100" style="">Incorporate your data and content seamlessly into the technology platforms powering your business operations, such as CRM, ERP, ESP, and beyond.</p>
            ...
            <div class="row mb-8 align-items-center">
                ...
                <div class="col-xl-5 col-lg-6 text-center text-md-start appear anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    <h2 class="text-dark-gray fw-600 ls-minus-3px alt-font highlight-separator-small" style="">Keep it all.</h2>
                    <p class="w-85 sm-w-100" style="">Maintain and retrieve your data conveniently through your Reviews Junction dashboard, integrated tech stack, or .csv file exports.</p>

                </div>

                <div class="col-lg-6 offset-xl-1 md-mb-50px sm-mb-30px">
                    <figure class="position-relative mb-0 overflow-hidden">
                        <img src="integrations/2.png" class="w-100"
                            alt="" data-no-retina="">
                        <figcaption
                            class="position-absolute text-center left-0px bottom-0px pt-35px pb-35px ps-15px pe-15px bg-white">
                            <span
