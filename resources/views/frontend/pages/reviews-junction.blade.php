...
@section('content')
    <section class="cover-background page-title-big-typography ipad-top-space-margin xs-py-0 appear anime-complete"
        style="padding-bottom: 0px !important; margin-top: inherit;"
        data-anime="{ &quot;opacity&quot;: [0, 1], &quot;easing&quot;: &quot;easeOutQuad&quot; }">
        <div class="container">
            <div class="row align-items-center extra-small-screen">
                <div class="col-9 col-xl-9 col-sm-6 position-relative page-title-extra-small appear anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;opacity&quot;: [0, 1], &quot;translateX&quot;: [-50, 0], &quot;duration&quot;: 800, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 150, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    <h1 class="mb-20px text-base-color fw-500 ls-minus-05px" style="">Reviews Junction</h1>
                    <h2 class=" fw-700 text-dark-gray mb-0 ls-minus-2px sm-ls-minus-1px" style="">Reviews Junction, a
                        Creating Waves of Satisfaction.
                    </h2>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 md-mb-20px appear anime-child anime-complete"
                    ...
                    <h3 class="fw-700 text-dark-gray ls-minus-1px mb-0 w-90 md-w-100" style="">Elevate Your Business
                        with Reviews Junction.</h3>
                </div>
                <div class="col-lg-5 offset-xl-1 last-paragraph-no-margin appear words lines splitting anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;lines&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 150, &quot;easing&quot;: &quot;easeOutQuad&quot; }"
                    style="--word-total: 22; --line-total: 4;"><span class="d-inline" style="will-change: inherit;">
                        Reviews Junction is a platform designed to gather valuable feedback from customers through reviews.
                        It enables businesses to collect, analyze, and utilize customer reviews to improve their products or
                        services. With Reviews Junction, companies can gain insights into customer satisfaction, identify
                        areas for improvement, and enhance overall customer experience. By harnessing the power of customer
                        feedback, businesses can make informed decisions and build stronger relationships with their
                        customers</span></div>
            </div>
            <div style="text-align: center" class="mt-5"><span
                    class="bg-base-color fw-600 lh-30 text-white text-uppercase border-radius-30px ps-20px pe-20px fs-35 mb-25px d-inline-block">Best
                    Features</span>
            </div>
            <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 justify-content-center mb-4 sm-mb-8 appear anime-child anime-complete"
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">Review App</span>
                            <p>Our team of has developed a fully-featured review app that always keeps improving. Compare us
                                with the competition and see why we are the best.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">The Lowest Price
                            </span>
                            <p>At Reviews Junction, we strongly believe software should become more affordable at scale. We
                                have never raised our price and never will.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">24/7 Customer
                                Service</span>
                            <p>We offer true 24/7 customer support. This includes help with installation, troubleshooting
                                and customizations so our widgets look great.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-auto text-center">
                    <div class="icon-with-text-style-06">
                        <div class="feature-box feature-box-left-icon-middle">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin">
                                <div class="text-dark-gray fs-20 ls-minus-05px">We Collect <span class="fw-600">customers
                                    </span>Feedback.</div>
                            </div>
                        </div>
                    </div>
    ...
    <section class="overflow-hidden bg-very-light-gray cover-background">
        <div class="container-fluid">
            <div class="row justify-content-center mb-2">
                <div class="col-12 text-center">
                    <span
                        class="bg-white box-shadow-quadruple-large text-uppercase fs-13 fw-700 ps-25px pe-25px lh-46 sm-lh-55 border-radius-100px d-inline-block mb-15px"><span
                            >Customer speaks</span></span>
                    <h2 class="text-dark-gray fw-700 w-90 sm-w-100 mx-auto ls-minus-1px">Valuable customers</h2>
                </div>
            </div>
            <div class="row align-items-center">
                <div class="col-12 position-relative appear anime-complete"
                    data-anime="{ &quot;translateX&quot;: [100, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 800, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 200, &quot;easing&quot;: &quot;easeOutQuad&quot; }"
                    style="">
                    <div class="swiper slider-three-slide swiper-initialized swiper-horizontal swiper-backface-hidden"
                        ...
                        <div class="swiper-wrapper pb-20px" id="swiper-wrapper-5531f9c92969633f" aria-live="off"
                            style="transition-duration: 0ms; transform: translate3d(-960px, 0px, 0px); transition-delay: 0ms;">
                            <div class="swiper-slide review-style-04 d-none d-lg-block h-auto" role="group"
                                aria-label="1 / 8" style="width: 290px; margin-right: 30px;"></div>

                            <div class="swiper-slide review-style-04" role="group" aria-label="2 / 8"
                                ...
                                <div
                                    ...
                                    <span class="fw-500 fs-20 text-dark-gray mb-15px">Alita Accessories
                                    </span>
                                    <p class="mb-20px">This team is doing great work! Since the app was installed, we have
                                        generated 80+ reviews. This app points to the daily delivery problems faced by the
                                        customers and other custom support issues. Thanks again for this app!</p>

                                </div>
                            </div>


                            <div class="swiper-slide review-style-04 swiper-slide-prev" role="group" aria-label="3 / 8"
                                style="width: 290px; margin-right: 30px;">
                                <div
                                    class="d-flex justify-content-center h-100 flex-column bg-white border-radius-6px p-15 xl-p-12 box-shadow-extra-large">
                                    <div class="review-star-icon fs-18 lh-24">
                                    ...
                                    <span class="fw-500 fs-20 text-dark-gray mb-15px">Eleshia</span>
                                    <p class="mb-20px">Installed a week ago and reviews started to come. Overall a very good experience. We are glad they are from Pakistan and providing good support.</p>

                                </div>
                            </div>


                            <div class="swiper-slide review-style-04 swiper-slide-active" role="group"
                                aria-label="4 / 8" style="width: 290px; margin-right: 30px;">
                                <div
                                    class="d-flex justify-content-center h-100 flex-column bg-white border-radius-6px p-15 xl-p-12 box-shadow-extra-large">
                                    <div class="review-star-icon fs-18 lh-24">
                                        <i class="bi bi-star-fill"></i><i class="bi bi-star-fill"></i><i
                                    ...
                                    <span class="fw-500 fs-20 text-dark-gray mb-15px">BodyNBody</span>
                                    <p class="mb-20px">We are using this app from a week and this app been impressive so far. In a week we generated 100+ authentic reviews. We are happy with their app.</p>

                                </div>
                            </div>


                            <div class="swiper-slide review-style-04 swiper-slide-next" role="group" aria-label="5 / 8"
                                style="width: 290px; margin-right: 30px;">
                                <div
                                    class="d-flex justify-content-center h-100 flex-column bg-white border-radius-6px p-15 xl-p-12 box-shadow-extra-large">
                                    <div class="review-star-icon fs-18 lh-24">
                                    ...
                                    <span class="fw-500 fs-20 text-dark-gray mb-15px">Fabiha Fatima</span>
                                    <p class="mb-20px">This app exceeded our expectations! Within just a week, it generated valuable reviews for our products. The customer service was very responsive, assisting us seamlessly in deploying new reviews widgets on our store. Highly recommend for apparel brands.</p>
                            ...
                            <div class="swiper-slide review-style-04 d-none d-lg-block h-auto" role="group"
                                aria-label="8 / 8" style="width: 290px; margin-right: 30px;"></div>
                        </div>
    ...
    <section class="position-relative pt-0">
        <div class="container position-relative z-index-1">
            <h2 class="fw-700 mt-5 ls-minus-1px text-dark-gray mb-10px" style="text-align: center">Our More Apps</h2>
            <div class="row row-cols-1 mt-5 row-cols-lg-3 row-cols-md-2 justify-content-center mb-6 sm-mb-9"
                ...
                <div class="col icon-with-text-style-04 transition-inner-all mb-30px">
                    <div
                        class="feature-box bg-white text-start justify-content-start h-100 border-radius-6px p-8 lg-p-13 box-shadow-quadruple-large box-shadow-quadruple-large-hover">
                        <div class="feature-box-icon">
                            <img src="https://cdn.shopify.com/app-store/listing_images/817038f6aeb5ba4dae3ddfa1a69e7738/icon/CImJ8q2o2oEDEAE=.jpeg"
                                class="w-85px" alt="">
                        </div>
                        <div class="feature-box-content last-paragraph-no-margin">
                            ...
                            <a href="{{ route('rj-loyalty') }}"
                                class="btn mt-3 btn-large btn-switch-text btn-round-edge btn-transparent-light-gray d-table d-lg-inline-block lg-mb-15px md-mx-auto">
                                <span>
                                    <span class="btn-double-text" data-text="Learn more">Learn more</span>
                                </span>
                            </a>
                            <a href="https://apps.shopify.com/rj-loyalty-rewards?surface_intra_position=2&surface_type=partners&surface_version=redesign"
                                target="_blank" style="border-radius: 10px !important;"
                                class="btn mt-3 btn-extra-large btn-rounded btn-transparent-dark-gray d-table d-lg-inline-block lg-mb-15px md-mx-auto">Install
                                now</a>
                        </div>
                    </div>
                </div>
        ...
        <div
            class="container-fluid position-absolute top-50 translate-middle-y z-index-minus-1 d-none d-md-block overflow-hidden">
            <div class="row position-relative">
                <div class="col swiper swiper-width-auto text-center pb-30px feather-shadow"
    ...
    <section class="background-position-center-top sm-background-image-none"
        style="background-image: url('images/vertical-line-bg.svg'); padding-top: 0px;">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-xl-5 col-lg-6 last-paragraph-no-margin md-mb-30px"
                    ...
                    <h3 class="alt-font fw-600 ls-minus-2px text-dark-gray"><span class="fw-800 d-inline-block">Our
                            Partners.</span></h3>
                    <p class="w-90 sm-w-100 d-inline-block">Utilize data aggregation and integration across your technology
                        infrastructure to gain deeper insights into customer behaviors and preferences, driving business
    ...
    <section class="background-position-center-top p-0 sm-background-image-none mb-5"
        ...
        <div class="container">
            <div class="row position-relative clients-style-08">
                <div class="col swiper text-center feather-shadow"
                    ...
                    <div class="swiper-wrapper marquee-slide">
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <a href="https://www.shopify.com/plus" target="_blank"><img
                                    src="shopify-plus-logo--black.jpg" class="h-40px xs-h-30px" alt="" /></a>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <a href="https://www.bazaarvoice.com/" target="_blank"><img src="bazaarvoice-logo.png"
                                    class="h-40px xs-h-30px" alt="" /></a>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <a href="https://www.klaviyo.com/" target="_blank"><img src="klaviyo-logo.jpg"
                                    class="h-40px xs-h-30px" alt="" /></a>
                        </div>
                        <!-- end client item -->
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <a href="https://mailchimp.com/" target="_blank">
                                <svg xmlns="http://www.w3.org/2000/svg" class="brandLogo brandLogo--lockup--animated"
                                    aria-label="Mailchimp" width="185" height="60" viewBox="0 0 185 60"
                                    role="img">
                                    ...
                                    <g class="brandLogo__wordMark" transform="translate(58,11) scale(.18)">
                                        <path
                                            d="M90.23,114.58c-20.7,0-21.06,22.6-25.96,22.6-1.02,0-1.83-.9-1.83-2.14,0-1.65,.43-3.08,.43-5.75,0-8.11-5.71-14.71-17.68-14.71-10.16,0-17.6,5.09-22.14,14.5-2.3,4.77-2.1,8.09-4.43,8.09-.86,0-1.53-.81-1.53-1.98,0-3.46,3.05-6.62,3.05-14.05,0-1.93-.15-3.56-.46-4.89H0v76.34H26.72v-41.42c0-8.16,3.5-13.39,9.47-13.39,3.96,0,7.48,3.46,7.48,9.79v45.02h26.72v-41.42c0-9.17,4.24-13.39,9.47-13.39,4.38,0,7.48,4.05,7.48,9.79v45.02h26.41v-46.87c0-20.48-8.13-31.15-23.51-31.15Z">
                                        </path>
                                        <rect x="246.57" y="94.88" width="26.41" height="97.71"></rect>
                                        <path
                                            d="M281.69,153.51c0,25.97,16.81,40.92,38.63,40.92,12.51,0,22.07-4.95,27.94-9.77v-25.19c-5.94,4.06-15.08,8.7-24.89,8.7-12.24,0-18.63-5.08-18.63-13.89s7.37-13.74,18.17-13.74c9.78,0,18.75,3.89,25.34,8.4v-26.72c-5.58-4.15-15.43-7.79-27.94-7.79-23.42,0-38.63,14.64-38.63,39.09Z">
                                        </path>
                                        <path
                                            d="M406.43,114.73c-10.74,0-16.96,4.98-21.53,14.2-2.01,4.07-2.16,8.09-4.43,8.09-.85,0-1.53-.79-1.53-1.98,0-4.23,5.04-10.54,5.04-29.16,0-4.68-.46-8.29-1.37-10.84h-23.05v97.56h26.72v-41.09c0-7.7,4.05-13.57,10.23-13.57,4.6,0,7.79,3.74,7.79,9.79v44.87h26.72v-47.79c0-19.94-8.7-30.08-24.58-30.08Z">
                                        </path>
                                        <path
                                        ...
                                        <path
                                            d="M161.49,114.43c-13.8,0-26.44,3.41-35.22,7.78v22.11c10.22-5.52,20.7-9.61,29.89-9.61,9.84,0,14.01,5.19,13.42,12.02-3.97-.41-8.38-.58-13.73-.58-20.9,0-34,8.16-34,25.92,0,14.59,11.36,22.11,23.79,22.11s20.47-5.8,25.3-14.54c2.75-4.98,2.52-8.03,4.31-8.03,.88,0,1.49,.63,1.49,1.61,0,3.19-.91,5.05-.91,9.37,0,4.04,.53,7.44,1.37,9.91h19.21v-40.87c0-23.21-10.62-37.21-34.92-37.21Zm-9,60.99c-4.96,0-7.62-2.17-7.62-5.95,0-4.92,4.63-8.69,16.62-8.69,2.64,0,5.03,.09,7.2,.27-1.06,7.03-7.18,14.37-16.2,14.37Z">
                                        </path>
                                        <path
                                            d="M256.75,44.31V1.48h-18.39V42.12c0,10.07-6.74,16.8-15.59,16.8s-15.59-6.74-15.59-16.8V1.48h-18.36l.1,42.83c0,18.65,14.93,32.29,33.9,32.29s33.93-13.61,33.93-32.29Z">
                                        </path>
                                        <polygon
                                            points="327.77 75.12 346.13 75.12 346.13 18.68 368.04 18.68 368.04 1.48 305.84 1.48 305.84 18.68 327.77 18.68 327.77 75.12">
                                        </polygon>
                                        <rect x="275.61" y="1.51" width="18.36" height="73.64"></rect>
                                        <polygon
                                            points="136.66 75.12 155.02 75.12 155.02 18.68 176.92 18.68 176.92 1.48 114.72 1.48 114.72 18.68 136.66 18.68 136.66 75.12">
                                        </polygon>
                                        <polygon points="18.36 38.34 18.36 1.51 0 1.51 0 75.14 18.36 75.14 18.36 38.34">
                                        </polygon>
                                        <path
                                            d="M55.57,34.48c0-10.07,6.74-16.8,15.59-16.8s15.59,6.74,15.59,16.8v40.64h18.36l-.05-42.83C105.05,13.63,90.1,0,71.13,0S37.2,13.61,37.2,32.29v42.83h18.36V34.48Z">
                                        </path>
                                        <path
                                            d="M571.17,114.58c-20.7,0-21.06,22.6-25.96,22.6-1.02,0-1.83-.9-1.83-2.14,0-1.65,.43-3.08,.43-5.75,0-8.11-5.71-14.71-17.68-14.71-10.16,0-17.6,5.09-22.14,14.5-2.3,4.77-2.1,8.09-4.43,8.09-.86,0-1.53-.81-1.53-1.98,0-3.46,3.05-6.62,3.05-14.05,0-1.93-.15-3.56-.46-4.89h-19.7v76.34h26.72v-41.42c0-8.16,3.5-13.39,9.47-13.39,3.96,0,7.48,3.46,7.48,9.79v45.02h26.72v-41.42c0-9.17,4.24-13.39,9.47-13.39,4.38,0,7.48,4.05,7.48,9.79v45.02h26.41v-46.87c0-20.48-8.13-31.15-23.51-31.15Z">
                                        </path>
                                        <path
                                            d="M455.59,121.6c-5.6,0-10.03-.81-13.28-2.44v73.44h26.41V119.16c-3.43,1.51-7.51,2.44-13.13,2.44Z">
                                        </path>
                                        <path
                                            d="M455.44,94.43c-10.92,0-16.64,4.83-16.64,10.38,0,5.98,6.77,10.38,16.64,10.38s16.64-4.4,16.64-10.38c0-5.55-5.73-10.38-16.64-10.38Z">
                                        </path>
                                        <path
                                            d="M221.61,121.6c-5.6,0-10.03-.81-13.28-2.44v73.44h26.41V119.16c-3.43,1.51-7.51,2.44-13.13,2.44Z">
                                        </path>
                                        <path
                                            d="M221.46,94.43c-10.92,0-16.64,4.83-16.64,10.38,0,5.98,6.77,10.38,16.64,10.38s16.64-4.4,16.64-10.38c0-5.55-5.73-10.38-16.64-10.38Z">
                                        </path>
                                    </g>
                                </svg>
                        ...
                        <!-- start client item -->
                        <div class="swiper-slide">
                            <a href="https://moose.com.pk/" target="_blank"
                                style="font-size: 23px; font-weight: 700;">Moose Commerce</a>
                        </div>
                        <!-- end client item -->
            ...
            <div class="row mt-5 justify-content-center mb-30px mx-0">
                <div
                    class="col-12 position-relative text-center bg-dark-gray p-40px border-radius-6px position-relative overflow-hidden lg-p-30px">
                    <h5
                        class="alt-font d-block d-xl-inline-block align-middle text-white mb-0 fw-600 me-35px lg-me-0 lg-mb-20px">
                        Grow Your Brand with Reviews Junction</h5>
                    <a href="{{ route('contact') }}"
                        class="btn btn-large btn-white btn-hover-animation-switch btn-round-edge btn-box-shadow btn-icon-left fw-700">
                        <span>
                    ...
                    <div class="bg-gradient-flamingo-amethyst-green h-6px w-100 position-absolute left-0px bottom-0px">
                    </div>
                </div>
            </div>
        </div>
