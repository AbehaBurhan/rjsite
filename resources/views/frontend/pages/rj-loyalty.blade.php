...
@section('content')
        ...
        <div class="container">
            <div class="row align-items-center extra-small-screen">
                <div class="col-9 col-xl-9 col-sm-6 position-relative page-title-extra-small appear anime-child anime-complete"
                    ...
                    <h1 class="mb-20px text-base-color fw-500 ls-minus-05px" style="">RJ: Loyalty & Rewards</h1>
                    <h2 class=" fw-700 text-dark-gray mb-0 ls-minus-2px sm-ls-minus-1px" style="font-size: 3rem !important;">
                        Enable customers to earn and utilize points for their engagements with your business.</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 md-mb-20px appear anime-child anime-complete"
                    ...
                    <h3 class="fw-700 text-dark-gray ls-minus-1px mb-0 w-90 md-w-100" style="">Customer Engagement:
                        Points Earned, Rewards Redeemed.</h3>
                </div>
                <div class="col-lg-5 offset-xl-1 last-paragraph-no-margin appear words lines splitting anime-child anime-complete"
                    ...
                    style="--word-total: 22; --line-total: 4;"><span class="d-inline" style="will-change: inherit;">
                        Discover RJ: Loyalty & Rewards, a key to transforming one-time shoppers into lifelong devotees.
                        Built exclusively for your store, Our app seamlessly enhances your store with powerful points,
                        rewards, and referral capabilities. Our feature-rich platform equips you for a thriving loyalty and
                        referral program. With a user-friendly setup wizard, you'll be up and running in no time. Have
                        inquiries or need assistance? Our dedicated support team is here to guide you every step of the
                        way!</span></div>
            </div>
            ...
            <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 justify-content-center mb-4 sm-mb-8 appear anime-child anime-complete"
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">Earn Points</span>
                            <p>Earn points with every purchase and unlock rewards for loyal customers. Join our program
                                today.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">Redeem Points
                            </span>
                            <p>Redeem points for discounts or freebies, enhancing value and fostering customer loyalty and
                                satisfaction.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">Insights</span>
                            <p>Analyze customer engagement and loyalty program effectiveness to optimize strategies and
                ...
                <div class="col-auto text-center">
                    <div class="icon-with-text-style-06">
                        <div class="feature-box feature-box-left-icon-middle">
                            ...
                            <div class="feature-box-content last-paragraph-no-margin">
                                <div class="text-dark-gray fs-20 ls-minus-05px">We Collect Customer Feedback to Improve
                                    <span class="fw-600">Loyalty Rewards</span> and Enhance Customer Satisfaction.</div>
                            </div>
                        </div>
                    </div>
                </div>
   ...
   @include('frontend.pages.loyalty-pricing')
            ...
            <div class="row mt-5 justify-content-center mb-30px mx-0">
                <div
                    ...
                    <h5
                        ...
                        Grow Your Brand with RJ: Loyalty & Rewards</h5>
