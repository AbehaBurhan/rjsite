...
@section('title', 'Why RJ ?')

@section('content')
    <section class="page-title-separate-breadcrumbs bg-sliding-line ipad-top-space-margin" style="margin-top: inherit;">
        <div class="container position-relative">
            <div class="row justify-content-center align-items-lg-end extra-very-small-screen appear anime-child anime-complete"
                data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                <div class="col-lg-6 position-relative page-title-extra-large md-mb-30px sm-mb-20px z-index-9" style="">
                    <h1 class="text-dark-gray fw-600 ls-minus-4px mb-0 alt-font highlight-separator-small"><span
                            class="highlight-separator mb-0 pb-0 shadow-in" data-shadow-animation="true"
                            data-animation-delay="500">Why<span><img
                                    src="images/demo-digital-agency-highlight-separator.png" alt=""
                                    data-no-retina=""></span></span> Reviews Junction ?</h1>
                </div>
                <div class="col-lg-6" style="">
                    <p class="fs-20 lh-32 text-dark-gray opacity-7 w-90 lg-w-100 md-w-80 mb-0">At Reviews Junction, we
                        specialize in collecting, analyzing, and presenting customer reviews to help businesses understand
                        their strengths and areas for improvement, fostering better experiences for all.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row mb-8 align-items-center">
                <div class="col-lg-6 md-mb-50px sm-mb-30px">
                    <figure class="position-relative mb-0 overflow-hidden">
                        <img src="https://craftohtml.themezaa.com/images/demo-digital-agency-01.jpg" class="w-100"
                            alt="" data-no-retina="">
                        <figcaption
                            class="position-absolute text-center left-0px bottom-0px pt-35px pb-35px ps-15px pe-15px bg-white">
                            <span
                                class="fs-90 lh-85 text-dark-gray ls-minus-2px position-relative fw-700 mb-5px d-block alt-font">28<sub
                ...
                <div class="col-xl-5 col-lg-6 offset-xl-1 text-center text-md-start appear anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    <h2 class="text-dark-gray fw-600 ls-minus-3px alt-font highlight-separator-small"
                        style="font-size: 2.438rem;">Collect more & Better Reviews</h2>
                    <p class="w-85 sm-w-100">Reviews Junction provides robust moderation and management tools to ensure the
                        quality and authenticity of reviews. Users can easily moderate submissions, respond to feedback, and
                        address customer concerns directly within the platform.</p>
                    <ul class="p-0 list-style-01 fw-500 mb-40px" style="">
                        <li class="border-color-transparent-dark-light pt-10px pb-10px text-dark-gray">Built-in moderation
                            tools for screening and approving reviews.</li>
                        <li class="border-color-transparent-dark-light pt-10px pb-10px text-dark-gray">Seamless integration
                            with customer support channels for efficient issue resolution.</li>
                        <li class="border-color-transparent-dark-light pt-10px pb-10px text-dark-gray">Tools for responding
                            to reviews and engaging with customers.</li>
                    </ul>
                    <div class="d-inline-block w-100 mt-15px sm-mt-0" style="">
                        <a href="{{ route('contact') }}"
                            class="btn btn-large btn-dark-gray btn-box-shadow d-inline-block align-middle me-20px sm-me-0 sm-mb-30px">Let's
                            talk now<i class="fa-regular fa-envelope"></i></a>
                        <a href="tel:+92 42 3544 1050"
                            class="d-block d-md-inline-block align-middle text-dark-gray text-dark-gray-hover fs-18 fw-600"><i
                                class="feather icon-feather-phone-call icon-small me-10px"></i>+92 42 3544 1050</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row mb-8 align-items-center">
                <div class="col-xl-5 col-lg-6 text-center text-md-start appear anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    <h2 class="text-dark-gray fw-600 ls-minus-3px alt-font highlight-separator-small"
                        style="font-size: 2.438rem;">Elevating Conversions with Performance Analytics.</h2>
                    <p class="w-85 sm-w-100">Empower your business and captivate customers with the Reviews Junction app,
                        offering unparalleled flexibility in crafting high-converting displays. Infused with critical
                        performance analytics, our platform guides you in optimizing strategies that resonate with your
                        brand identity and boost conversion rates. Explore the synergy of aesthetics and functionality with
                        genuinely beautiful displays tailored to your unique vision. Elevate your online presence, engage
                        your audience, and drive results with Reviews Junction.
                    </p>
                    <ul class="p-0 list-style-01 fw-500 mb-40px" style="">
                        <li class="border-color-transparent-dark-light pt-10px pb-10px text-dark-gray"> Customize displays
                            to seamlessly integrate with your brand identity, fostering a cohesive online experience for
                            customers.</li>
                        <li class="border-color-transparent-dark-light pt-10px pb-10px text-dark-gray">With Reviews
                            Junction, enjoy unparalleled flexibility in design and layout, allowing for dynamic adjustments
                            tailored to changing business needs and customer preferences.</li>
        ...
        <div class="container">
            <div class="row mb-8 align-items-center">
                ...
                <div class="col-xl-5 col-lg-6 offset-xl-1 text-center text-md-start appear anime-child anime-complete"
                    data-anime="{ &quot;el&quot;: &quot;childs&quot;, &quot;translateY&quot;: [30, 0], &quot;opacity&quot;: [0,1], &quot;duration&quot;: 600, &quot;delay&quot;: 0, &quot;staggervalue&quot;: 300, &quot;easing&quot;: &quot;easeOutQuad&quot; }">
                    <h2 class="text-dark-gray fw-600 ls-minus-3px alt-font highlight-separator-small"
                        style="font-size: 2.438rem;">Elevating Syndication and Sharing Quality Content</h2>
                    <p class="w-85 sm-w-100">Unlock unparalleled potential for your brand with top-tier syndication and
                        sharing strategies that extend the reach of collected content. Our platform ensures that every piece
                        of valuable feedback and review is amplified, allowing retailers to showcase an abundance of
                        high-quality content directly on their websites. Experience the power of seamless syndication and
                        sharing mechanisms that elevate brand visibility, foster trust, and drive unparalleled engagement.
                        With our solution, brands and retailers unite to create an expansive ecosystem where quality content
                        flourishes, benefiting both parties and delighting customers at every turn. Amplify your impact and
                        propel your brand to new heights with our syndication and sharing solution.</p>
    ...
    <section class="background-position-center-top sm-background-image-none" style="background-image: url('images/vertical-line-bg.svg'); padding-top: 0px;">
        <div class="container">
