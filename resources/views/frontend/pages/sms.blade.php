        ...
        <div class="container">
            <div class="row align-items-center extra-small-screen">
                <div class="col-9 col-xl-9 col-sm-6 position-relative page-title-extra-small appear anime-child anime-complete"
                    ...
                    <h1 class="mb-20px text-base-color fw-500 ls-minus-05px" style="">RJ SMS Verify COD Notification.
                    </h1>
                    <h2 class=" fw-700 text-dark-gray mb-0 ls-minus-2px sm-ls-minus-1px" style="font-size: 3rem !important;">
                    Fraud Prevention App: Secure Customer Orders.</h2>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 md-mb-20px appear anime-child anime-complete"
                    ...
                    <h3 class="fw-700 text-dark-gray ls-minus-1px mb-0 w-90 md-w-100" style="">Fraud Prevention & Order Verification.</h3>
                </div>
                <div class="col-lg-5 offset-xl-1 last-paragraph-no-margin appear words lines splitting anime-child anime-complete"
                    ...
                    style="--word-total: 22; --line-total: 4;"><span class="d-inline" style="will-change: inherit;">
                        The app efficiently reduces fraudulent orders from anonymous customers by sending instant SMS
                        confirmations with unique URLs. Customers verify their orders through the link, updating the status
                        to "confirmed," while unconfirmed orders are marked as "pending" for manual review. Simple to
                        install and set up, the app enhances security, streamlines transactions, and safeguards businesses
                        from bogus orders.
                    </span></div>
            </div>
            ...
            <div class="row row-cols-1 row-cols-lg-3 row-cols-sm-2 justify-content-center mb-4 sm-mb-8 appear anime-child anime-complete"
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">Combat Fraudulent Orders</span>
                            <p>Combat fraudulent orders from unidentified customers effectively.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">Effortless Installation and Setup</span>
                            <p>User-friendly installation and setup for effortless configuration.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col icon-with-text-style-03" style="">
                    <div class="feature-box p-8 overflow-hidden">
                        ...
                        <div class="feature-box-content last-paragraph-no-margin">
                            <span class="d-block fs-18 fw-600 text-dark-gray mb-5px ls-minus-05px">Instant Real-time SMS
                                Confirmations</span>
                            <p>Real-time SMS confirmations for instant order verification.</p>
                        </div>
                    </div>
                </div>
            </div>
            @include('frontend.pages.smspricing')
        </div>
    </section>
                ...
                <div class="col swiper text-center feather-shadow"
                    ...
                    <div class="swiper-wrapper marquee-slide">
                        ...
                        <div class="swiper-slide">
                            <a href="https://www.shopify.com/plus" target="_blank"><img src="shopify-plus-logo--black.jpg"
            ...
            <div class="row mt-5 justify-content-center mb-30px mx-0">
                <div
                    ...
                    <h5
                        ...
                        Grow Your Brand with RJ: SMS Verification</h5>
